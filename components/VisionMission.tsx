    ...
    <section className="py-24 bg-[#f4f6f8] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          {/* Main Title Block */}
          <div className="md:col-span-12 lg:col-span-4 bg-white p-10 rounded-[2rem] border border-gray-200/60 shadow-sm flex flex-col justify-center">
          ...
          {/* Card 1: Vision */}
          <div className="md:col-span-6 lg:col-span-4 bg-navy p-10 rounded-[2rem] shadow-sm relative overflow-hidden group flex flex-col justify-between">
          ...
          {/* Card 2: Mission */}
          <div className="md:col-span-6 lg:col-span-4 bg-brand-green p-10 rounded-[2rem] shadow-sm relative overflow-hidden group flex flex-col justify-between">
